...
import {PerfectListTableComponent} from './perfect-list-table.component';

describe('PerfectListTableComponent', () => {
  let spectator: Spectator<PerfectListTableComponent>;
  let perfectListService: SpyObject<PerfectListService>;
  let loader: HarnessLoader;
  let docLoader: HarnessLoader;

  const createComponent = createComponentFactory({
    component: PerfectListTableComponent,
    imports: [
      MatButtonModule,
      MatIconModule,
      MatDatepickerModule,
    ...
    mocks: [MatDialog, PerfectListService, MeUserPreferencesService],
    detectChanges: false,
  });
  ...
  beforeEach(async () => {
    ...
    perfectListService.getMulti.and.returnValue(of([]));
