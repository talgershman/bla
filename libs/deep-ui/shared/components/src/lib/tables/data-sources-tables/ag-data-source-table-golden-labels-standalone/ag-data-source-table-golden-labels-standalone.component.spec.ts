...
import {AgDataSourceTableGoldenLabelsStandaloneComponent} from './ag-data-source-table-golden-labels-standalone.component';
...
describe('AgDataSourceTablePerfectsStandaloneComponent', () => {
  let spectator: Spectator<AgDataSourceTableGoldenLabelsStandaloneComponent>;
  let agDatasourceService: SpyObject<AgDatasourceService>;
  let router: SpyObject<Router>;

  const createComponent = createComponentFactory({
    component: AgDataSourceTableGoldenLabelsStandaloneComponent,
    imports: [
      MatIconModule,
      MatButtonModule,
      MatDialogModule,
