...
import {AgDataSourceTableGoldenLabelsComponent} from './ag-data-source-table-golden-labels.component';

describe('AgDataSourceTablePerfectsComponent', () => {
  let spectator: Spectator<AgDataSourceTableGoldenLabelsComponent>;
  let datasourceService: SpyObject<DatasourceService>;
  let docLoader: HarnessLoader;

  const createComponent = createComponentFactory({
    component: AgDataSourceTableGoldenLabelsComponent,
    imports: [
      MatButtonModule,
      MatDialogModule,
      MeTooltipDirective,
