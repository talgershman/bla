...
describe('SingleVersionComponent - Integration', () => {
  ...
  describe('wizard flow', () => {
    ...
    //     },
    //   });
    //   (submitRequest as any).mest.mestOutputsNickname = 'nick1';
    //   (submitRequest as any).mest.mestSyncLocalDirectory = '/some-path/';
    //   mestService.validatePath.and.returnValue(of(null));
    //
    ...
    //     mestOutputsNickname: 'nick1',
    //     mestSyncLocalDirectory: '/some-path/',
    //   });
    ...
    it('should create full run - ETL only data prep', async () => {
      spectator.setInput('runType', EtlJobRunType.FULL_RUN);
      const submitRequest = getExpectedSubmitJobRequest(etlsData.etls[1][3], mestsArr[0], {
        flowType: EtlJobFlowsEnum.SINGLE_VERSION,
        runType: spectator.component.runType(),
        mergeParsedData: true,
        createDatasourceFromParsedData: true,
        ...
        probe: {
          id: etlsData.etls[1][3].id as unknown as string,
          params: {
            dataPrep: {
              id: 1,
              configuration: {
