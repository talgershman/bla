...
import {ExecuteQueryWebSocketsManagerService} from './execute-query-web-sockets-manager.service';

describe('ExecuteQueryWebSocketsManagerService', () => {
  let spectator: SpectatorHttp<ExecuteQueryWebSocketsManagerService>;
  const fakeConnection = new WebSocketSubject('bla');

  const createHttp = createHttpFactory({
    service: ExecuteQueryWebSocketsManagerService,
  });
