...
import {MeClientSideTableComponent} from './client-side-table.component';
...
describe('MeClientSideTableComponent', () => {
  let spectator: Spectator<MeClientSideTableComponent<any>>;
  let userPreferencesService: SpyObject<MeUserPreferencesService>;

  const createComponent = createComponentFactory({
    component: MeClientSideTableComponent,
    imports: [
      AgGridModule,
      ReactiveFormsModule,
    ...
    providers: [MeClientSideTableService, MePortalService],
  ...
  beforeEach(() => {
    ...
    spectator.component.ignoredColIds = IGNORED_COL_IDS;
  ...
  it('onGridReady should call addRowGroupColumns and removeRowGroupColumns', async () => {
    const secondGroup: MeGroupByItem = {
      groups: [
        {
          colId: 'col1',
          field: 'col1',
  ...
  it('onGroupByChanged should call addRowGroupColumns and removeRowGroupColumns', async () => {
    ...
    const dynamicItem: MeGroupByItemDerived = {
      ...secondGroup,
      key: 'col1-col2',
    };
    spectator.component.onGroupByChanged(dynamicItem);
    spectator.detectChanges();
